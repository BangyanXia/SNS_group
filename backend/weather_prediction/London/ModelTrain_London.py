...
# 读取数据
train_df = pd.read_csv('London_Weather_Train.csv')
test_df = pd.read_csv('London_Weather_Test.csv')
...
joblib.dump(scaler_y, "scaler_y_L.pkl")

print("✅ scaler_y 已保存到 scaler_y_L.pkl")
'''
...
torch.save(X_test, "X_test_tensor_L.pth")  # 保存 X_test
print("✅ X_test 已保存到 X_test_tensor_L.pth")
